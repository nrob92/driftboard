  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload: {
          eventType?: string;
          new?: { user_id?: string; status?: string; session_id?: string };
          old?: { user_id?: string };
        }) => {
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
          <div>
            ...
            <p className="text-gray-400 max-w-lg">
              Create a collaborative workspace or join your team&apos;s existing
              sessions to edit and organize photos together in realtime.
            </p>
          </div>
        ...
        {loadingData ? (
          <div className="grid gap-4">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="border border-[#2a2a2a] bg-[#111] rounded-2xl p-6 animate-pulse"
              >
          ...
          <div className="text-center py-24 bg-[#111] border border-[#2a2a2a] rounded-2xl">
            ...
            <p className="text-gray-500 mb-8 max-w-xs mx-auto">
              Start your first collaborative project by creating a session or
                      ...
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        {isOwner && pendingRequests[session.id] > 0 && (
                          <span className="animate-pulse px-2.5 py-1 bg-yellow-500/20 text-yellow-400 text-[10px] font-bold uppercase tracking-wider rounded-full border border-yellow-500/20">
                            {pendingRequests[session.id]} New Request
                            {pendingRequests[session.id] > 1 ? "s" : ""}
                          </span>
                        )}
                      </div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-[#171717] border border-[#2a2a2a] rounded-2xl p-8 w-full max-w-md shadow-2xl">
            ...
            <p className="text-gray-400 text-sm mb-6">
              Give your collaborative workspace a name to get started.
            </p>
      ...
      {showJoinModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-[#171717] border border-[#2a2a2a] rounded-2xl p-8 w-full max-w-md shadow-2xl">
            ...
            <p className="text-gray-400 text-sm mb-6">
              Enter the 8-character invite code provided by the session master.
            </p>
