          ...
          <div className="bg-[#171717] border border-[#2a2a2a] rounded-2xl shadow-2xl shadow-black/50 p-6 w-full max-w-96 mx-4">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                onChange={(e) => {
                  ui.setEditingFolderName(e.target.value);
                  ui.setFolderNameError("");
                }}
                ...
                <button
                  onClick={() => {
                    ...
                    if (
                      ...
                      ui.setDeleteFolderDontAskAgain(false);
                      ui.setConfirmDeleteFolderOpen(true);
                    }
                  }}
          ...
          <div className="bg-[#171717] border border-[#2a2a2a] rounded-2xl shadow-2xl shadow-black/50 p-6 w-full max-w-96 mx-4">
            ...
            <label className="flex items-center gap-2 mb-4 cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  ui.setDeletePhotoDontAskAgain(e.target.checked)
                }
            ...
            <div className="flex gap-3">
              <button
                type="button"
                onClick={() => ui.setConfirmDeletePhotoIds(null)}
                className="flex-1 px-4 py-2.5 text-sm font-medium text-[#999] bg-[#252525] hover:bg-[#333] rounded-xl transition-colors cursor-pointer"
              >
                Cancel
              </button>
              <button
                ...
                onClick={async () => {
                  ...
                  ui.setConfirmDeletePhotoIds(null);
          ...
          <div className="bg-[#171717] border border-[#2a2a2a] rounded-2xl shadow-2xl shadow-black/50 p-6 w-full max-w-96 mx-4">
            ...
            <label className="flex items-center gap-2 mb-4 cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  ui.setDeleteFolderDontAskAgain(e.target.checked)
                }
                className="rounded border-[#333] bg-[#252525] text-[#3ECF8E] focus:ring-[#3ECF8E]/20"
              />
              <span className="text-sm text-[#888]">Don&apos;t ask again</span>
            ...
            <div className="flex gap-3">
              <button
                type="button"
                onClick={() => ui.setConfirmDeleteFolderOpen(false)}
                className="flex-1 px-4 py-2.5 text-sm font-medium text-[#999] bg-[#252525] hover:bg-[#333] rounded-xl transition-colors cursor-pointer"
              >
                Cancel
              </button>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-[#171717] border border-[#2a2a2a] rounded-2xl shadow-2xl shadow-black/50 p-6 w-full max-w-96 mx-4">
            ...
            <input
              ...
              onChange={(e) => {
                ui.setCreateEmptyFolderName(e.target.value);
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-[#171717] border border-[#2a2a2a] rounded-2xl shadow-2xl shadow-black/50 p-6 w-full max-w-96 mx-4">
            ...
            <input
              ...
              onChange={(e) => {
                ui.setCreateSocialLayoutName(e.target.value);
            ...
            <select
              ...
              onChange={(e) =>
                ui.setCreateSocialLayoutPages(Number(e.target.value))
              }
          ...
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center">
            <div className="bg-[#171717] border border-[#2a2a2a] rounded-2xl shadow-2xl shadow-black/50 p-6 w-full max-w-96 mx-4">
              ...
              <input
                ...
                onChange={(e) => {
                  ui.setCreateFolderFromSelectionName(e.target.value);
      ...
      {canvasContextMenu && (
        ...
        >
          <button
            type="button"
            onClick={() => {
              ui.setCanvasContextMenu(null);
              ui.setCreateEmptyFolderOpen(true);
              ui.setCreateEmptyFolderName("New Folder");
              ui.setCreateEmptyFolderNameError("");
            }}
          ...
          <button
            ...
            onClick={() => {
              ui.setCanvasContextMenu(null);
              ui.setCreateSocialLayoutOpen(true);
              ui.setCreateSocialLayoutName("Social layout 1");
          ...
          return (
            ...
            >
              {isLayout && (
                <>
                  ...
                  <button
                    ...
                    disabled={!canAdd}
                    className="w-full px-4 py-3.5 md:py-2.5 text-left text-sm text-white hover:bg-[#252525] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                    Add page
                  </button>
                  <button
              ...
              <button
                type="button"
                onClick={() => {
                  ui.setFolderContextMenu(null);
                  ui.setEditingFolder(folder);
                  ui.setEditingFolderName(folder.name);
                  ui.setFolderNameError("");
                }}
                className="w-full px-4 py-3.5 md:py-2.5 text-left text-sm text-white hover:bg-[#252525] transition-colors"
              >
                Rename
              </button>
              <button
                ...
                className="w-full px-4 py-3.5 md:py-2.5 text-left text-sm text-red-400 hover:bg-red-400/10 transition-colors border-t border-[#2a2a2a]"
              >
                Delete folder
              </button>
            </div>
          ...
          {imageContextMenu.selectedIds.length > 1 ? (
              ...
              <button
                ...
                onClick={() => {
                  ...
                  if (
                    ...
                    ui.setDeletePhotoDontAskAgain(false);
                    ui.setConfirmDeletePhotoIds(ids);
                  }
                }}
                className="w-full px-4 py-3.5 md:py-2.5 text-left text-sm text-red-400 hover:bg-red-400/10 transition-colors border-t border-[#2a2a2a]"
              >
            ...
            <>
              ...
              <button
                type="button"
                onClick={() => {
                  ui.setBorderDialogImageId(imageContextMenu.imageId);
                  ui.setImageContextMenu(null);
                }}
                className="w-full px-4 py-3.5 md:py-2.5 text-left text-sm text-white hover:bg-[#252525] transition-colors"
              >
        ...
        (() => {
          ...
          return (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
              <div
                ref={borderDialogRef}
                className="bg-[#171717] border border-[#2a2a2a] rounded-2xl shadow-2xl shadow-black/50 p-6 w-full max-w-96 mx-4"
              >
                ...
                <div className="flex gap-2 justify-end mt-6">
                  <button
                    type="button"
                    onClick={() => ui.setBorderDialogImageId(null)}
      ...
      {createPresetFromImageId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="bg-[#171717] border border-[#2a2a2a] rounded-2xl shadow-2xl shadow-black/50 p-6 w-full max-w-96 mx-4">
            ...
            <p className="text-sm text-[#888] mb-4">
              Save this image&apos;s edits as a preset you can apply to other
              photos.
            </p>
            <input
              type="text"
              value={createPresetName}
              onChange={(e) => ui.setCreatePresetName(e.target.value)}
              onKeyDown={(e) => {
